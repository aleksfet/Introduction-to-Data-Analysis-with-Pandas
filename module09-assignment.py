...
top_categories_temp = region_category_sales.groupby(level=0).idxmax()
top_categories_by_region = top_categories_temp.str[1]
...
print("1. Focus more marketing and inventory efforts on the highest-performing region since it brings in the most revenue.")
print("2. Continue using promotions strategically because promoted items have strong overall revenue performance.")
print("3. Review missing data in Units and Unit_Price columns to improve reporting accuracy and business decisions.")